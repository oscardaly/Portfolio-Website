        ...
        <section>
            <div className="bg-white">
                <div className="relative isolate px-6 lg:px-8">
                    ...
                    <div>
                        <h1 className="scroll-m-20 text-center text-4xl font-extrabold tracking-tight text-balance">Projects</h1>
                    ...
                    <div className="space-x-4 flex flex-col">
                        <h1 className="scroll-m-20 text-center text-4xl font-extrabold tracking-tight text-balance">Blogs</h1>
                        <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
                            <li>
                                <Button variant="link">
                                    <Link
                    ...
                    <div className="space-x-4 flex flex-col">
                        <h1 className="scroll-m-20 text-center text-4xl font-extrabold tracking-tight text-balance">Conferences...</h1>
